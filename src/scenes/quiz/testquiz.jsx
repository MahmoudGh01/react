...
const TestQuiz = () => {
    ...
    useEffect(() => {
        const fetchTestQuizs = async () => {
            try {
                const response = await axios.get(`http://192.168.31.57:10000/testQuizByRecruter/661e2edf36e2c6c7a2422722`);
    ...
    const fetchQuiz = async (idquiz) => {
        try {
            const response = await axios.get(`http://192.168.31.57:10000/onequiz/${idquiz}`);
    ...
    const fetchCandidat = async (idcandidat) => {
        try {
            const response = await axios.get(`http://192.168.31.57:10000/onecandidat/${idcandidat}`);
