...
const ShowQuiz = () => {
    ...
    useEffect(() => {
        const fetchQuiz = async () => {
            try {
                const response = await axios.get(`http://192.168.31.57:10000/onequiz/${id}`);
        ...
        const fetchCandidats = async () => {
            try {
                const response = await axios.get('http://192.168.31.57:10000/all_candidat');
    ...
    const updateQuestions = async (q) => {
        try {
            const response = await axios.put(`http://192.168.31.57:10000/updateQuiz/${id}`,
                {
                    questions: q,
                },
                {
    ...
    const handleAffecter = async (values) => {
        try {
            await axios.post(
                "http://192.168.31.57:10000/affecter",
                {
